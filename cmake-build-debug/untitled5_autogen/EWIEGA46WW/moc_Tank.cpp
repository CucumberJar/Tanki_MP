...
namespace {
struct qt_meta_tag_ZN4TankE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN4TankE = QtMocHelpers::stringData(
    "Tank"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN4TankE[] = {
...
Q_CONSTINIT const QMetaObject Tank::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4TankE.offsetsAndSizes,
    qt_meta_data_ZN4TankE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4TankE_t,
        // Q_OBJECT / Q_GADGET
...
void *Tank::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4TankE.stringdata0))
